...
- [NewUno](/pkg/api/uno.go) - When NewUno is called, before the instace, these are created:
  - [NewConfig](/pkg/api/uno.go) - Creates new config instance. All children config tree nodes are created and populated with values from .env file, or by default values.
  - [NewServer](/pkg/api/server.go) - Creates new Server instance
  - [NewRouter](/pkg/api/router.go) - Creates new Router instance
  - [NewDB](/pkg/db/db.go) - Creates new DB instance
    - [NewMigrate](/pkg/db/migrate.go) - Creates new Migrator instance
